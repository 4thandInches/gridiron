...
class PlaysControllerTest < ActionController::TestCase
  ...
  test "should create play" do
    assert_difference('Play.count') do
      post :create, play: { formation_id: @play.formation_id, name: @play.name, pdf_file: @play.pdf_file }
    end
  ...
  test "should update play" do
    patch :update, id: @play, play: { formation_id: @play.formation_id, name: @play.name, pdf_file: @play.pdf_file }
    assert_redirected_to play_path(assigns(:play))
  end
